...
<head>
  ...
  <title>Form User - Website Monitoring IT Solution</title>
  ...
  <main>
    <div class="container">
      ...
      <div class="page-header">
        <h2>{{ isset($user) ? 'Edit User' : 'Tambah User Baru' }}</h2>
        <p>{{ isset($user) ? 'Perbarui informasi akun, role, status, atau password pengguna.' : 'Daftarkan akun pengguna baru ke dalam sistem pemantauan.' }}</p>
      </div>
