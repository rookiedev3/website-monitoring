  ...
  <style>
    ...
    * {
    ...
    main {
      ...
      flex: 1;
      /* Atas tetap 85px agar aman dari navbar, kiri-kanan diperkecil jadi 12px agar lebih melebar */
...
<body>
    ...
    <div class="container">
      ...
      <div class="page-header">
        <div>
          ...
          <p>Kelola daftar akun pengguna, role, dan hak akses ke dalam sistem monitoring.</p>
        </div>
      ...
      <div class="filter-card">
        <div class="filter-grid">
          <div class="search-box">
            ...
            <input type="text" id="search-input" placeholder="Cari berdasarkan nama atau email user...">
          </div>
      ...
      <div class="card">
        <div class="table-responsive">
          <table>
            <thead>
              <tr>
                <th style="width: 26%;">Nama User</th>
                <th style="width: 26%;">Email</th>
                <th style="width: 18%;">Role / Hak Akses</th>
                <th style="width: 14%;">Status Akun</th>
            ...
            <tbody id="user-table-body">
              ...
              @empty
                <tr>
                  <td colspan="5" style="text-align: center; color: var(--muted); padding: 30px; font-weight: 600;">
        ...
        <!-- UI Pagination Navigator User Management -->
  ...
  <script>
    ...
    const destroyUrlTemplate = "{{ route('users.destroy', ':id') }}";
    ...
    function renderTable() {
      ...
      const filteredUsers = rawUsersData.filter(user => {
        const matchesSearch =
      ...
      if (totalItems === 0) {
        tbody.innerHTML = `<tr><td colspan="5" style="text-align:center; color:var(--muted); padding:30px; font-weight: 600;">Tidak ada data user yang ditemukan.</td></tr>`;
      ...
      pageItems.forEach(user => {
        ...
        const destroyUrl = destroyUrlTemplate.replace(':id', user.id);
          ...
          <tr>
            <td>
              <div class="user-cell">
                ...
                <b style="color: #172033;">${user.name}</b>
              </div>
            </td>
            <td>
