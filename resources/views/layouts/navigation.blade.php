<style>
  ...
  .notif-icon-dot.danger {
    background: #ef4444;
    box-shadow: 0 0 8px #ef4444;
  }

  .notif-icon-dot.success {
    background: #22c55e;
  ...
  .mobile-menu-btn:hover {
    background: var(--card-hover, #1f3328);
  }
  ...
  aside#sidebar.collapsed .sidebar-toggle-text {
    display: none;
  }

  aside#sidebar.collapsed .sidebar-toggle-bar {
    justify-content: center;
  }
